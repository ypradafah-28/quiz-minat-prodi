...
/* ============ 2. RUMPUN PRODI ============ */
const RUMPUN = {
  r1: { nama: "Saintek, Kesehatan & Agro", ikon: "🧪" },
  r2: { nama: "Soshum & Bisnis",           ikon: "💼" },
  r3: { nama: "Seni & Budaya",             ikon: "🎨" },
};

/* ============ 3. BANK SOAL (10 SOAL) ============ */
const SOAL_BANK = [
  {
    id: 1, rumpun: "r1", tags: "it data",
    ringkas: "teknologi, pemrograman & data digital",
    teks: "Apakah kamu tertarik merancang perangkat lunak, memrogram komputer, atau menganalisis data digital?",
    kataKunci: ["software", "perangkat lunak", "program", "komputer", "data", "digital", "sistem informasi", "informatika", "artifisial", "algoritma", "coding", "pemrograman", "aplikasi", "website", "teknologi", "sains data"],
  },
  {
    id: 2, rumpun: "r1", tags: "sains",
    ringkas: "sains & penelitian",
    teks: "Apakah kamu senang melakukan eksperimen laboratorium dan meneliti fenomena sains?",
    kataKunci: ["eksperimen", "laboratorium", "sains", "penelitian", "biologi", "fisika", "kimia", "ilmiah", "praktikum", "mikroskop", "reaksi", "materi"],
  },
  {
    id: 3, rumpun: "r1", tags: "teknik",
    ringkas: "teknik, mesin & konstruksi",
    teks: "Apakah kamu berminat membongkar-pasang mesin, merancang bangunan, atau mengulik sistem teknik?",
    kataKunci: ["teknik", "mesin", "sipil", "elektro", "bangunan", "konstruksi", "listrik", "otomasi", "otomotif", "manufaktur", "gambar teknik", "permesinan", "robotika", "instalasi", "struktur"],
  },
  {
    id: 4, rumpun: "r1", tags: "kesehatan",
    ringkas: "kesehatan & medis",
    teks: "Apakah kamu ingin bekerja di bidang medis, merawat kesehatan manusia, atau mempelajari ilmu gizi?",
    kataKunci: ["kesehatan", "kedokteran", "medis", "keperawatan", "kebidanan", "gizi", "terapi", "rumah sakit", "anatomi", "fisiologi", "klinis", "farmasi", "dokter", "perawat", "pasien", "tumbuh kembang"],
  },
  {
    id: 5, rumpun: "r2", tags: "bisnis akuntansi",
    ringkas: "bisnis, keuangan & pasar",
    teks: "Apakah kamu suka mengolah data keuangan, menyusun strategi bisnis, atau menganalisis pasar?",
    kataKunci: ["bisnis", "ekonomi", "manajemen", "akuntansi", "keuangan", "pasar", "wirausaha", "pemasaran", "audit", "pajak", "perbankan", "startup", "modal", "investasi", "laba", "usaha"],
  },
  {
    id: 6, rumpun: "r2", tags: "hukum sosial hi",
    ringkas: "hukum, kebijakan & isu sosial",
    teks: "Apakah kamu tertarik mempelajari hukum, kebijakan publik, isu sosial, atau hubungan internasional?",
    kataKunci: ["hukum", "kebijakan", "sosial", "politik", "internasional", "publik", "administrasi", "legislatif", "diplomasi", "pemerintahan", "negara", "perundangan", "kewarganegaraan", "kesejahteraan"],
  },
  {
    id: 7, rumpun: "r2", tags: "bahasa komunikasi",
    ringkas: "bahasa, sastra & komunikasi",
    teks: "Apakah kamu senang mempelajari bahasa asing, menulis karya sastra, atau mengolah media komunikasi?",
    kataKunci: ["bahasa", "sastra", "linguistik", "komunikasi", "media", "jurnalistik", "menulis", "budaya", "bipa", "terjemah", "translator", "sastrawan", "public speaking", "literasi"],
  },
  {
    id: 8, rumpun: "r3", tags: "seni desain film",
    ringkas: "seni, desain & kreativitas",
    teks: "Apakah kamu menikmati kegiatan menggambar, membuat animasi/film, atau merancang karya desain visual?",
    kataKunci: ["desain", "seni", "animasi", "film", "rupa", "grafis", "ilustrasi", "fotografi", "kreatif", "visual", "gambar", "mural", "kriya", "lukis", "estetika", "musik", "tari"],
  },
  {
    id: 9, rumpun: "r2", tags: "pendidikan psikologi",
    ringkas: "pendidikan & psikologi",
    teks: "Apakah kamu berminat mengajar, mendampingi tumbuh kembang anak, atau memahami psikologi manusia?",
    kataKunci: ["guru", "pendidikan", "mengajar", "paud", "sekolah", "psikologi", "konseling", "tumbuh kembang", "anak", "dosen", "pedagogi", "belajar", "pembelajaran", "bimbingan"],
  },
  {
    id: 10, rumpun: "r1", tags: "olahraga pariwisata",
    ringkas: "olahraga, kebugaran & pariwisata",
    teks: "Apakah kamu menyukai aktivitas fisik, dunia keolahragaan, atau pengorganisasian industri pariwisata?",
    kataKunci: ["olahraga", "jasmani", "kebugaran", "kepelatihan", "atlet", "fitness", "gym", "pariwisata", "wisata", "perhotelan", "event", "rekreasi", "pelatih", "prestasi", "fisik"],
  },
];
...
function buatAlasan(p) {
  ...
  if (p.alasan && p.alasan.length) {
    return `Karena kamu menjawab "Ya" pada minat ${p.alasan.join(", ")}. Prodi ini memiliki fokus dan prospek yang selaras dengan minat tersebut.`;
  }
  return `Minatmu lebih condong ke rumpun ${r.ikon} ${r.nama}. Prodi ini termasuk dalam rumpun tersebut dan layak dipertimbangkan.`;
}
...
function hitungSkor() {
  return PRODI_LIST.map((prodi) => {
    ...
    let skor = 0;
    const alasan = []; // label minat yang cocok untuk "mengapa cocok"
    ...
    soalAktif.forEach((soal, qi) => {
      ...
      if (nilai > 0 && (tagCocok > 0 || kunciCocok > 0)) alasan.push(soal.ringkas);
    });

    return { nama, fakultas, rumpun, skor, alasan, info, tags: prodi[3] };
  });
}
  ...
  top5.forEach((p, i) => {
    ...
    card.innerHTML = `
      ...
      <div class="result-detail hidden">
        <span class="rumpun-badge ${badgeRumpun}">${r.ikon} ${esc(r.nama)}</span>
