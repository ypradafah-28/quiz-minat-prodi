...
const KONFIGURASI = {
  ...
  opsiJawaban: [          // pilihan jawaban: 5 skala sesuai/tidak sesuai
    { label: "Sangat Sesuai",      skor: 2,  emoji: "😍" },
    { label: "Sesuai",              skor: 1,  emoji: "🙂" },
    { label: "Netral",              skor: 0,  emoji: "😐" },
    { label: "Tidak Sesuai",        skor: -1, emoji: "🙁" },
    { label: "Sangat Tidak Sesuai", skor: -2, emoji: "😞" },
  ],
};
